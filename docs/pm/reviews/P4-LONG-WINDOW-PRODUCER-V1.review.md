# Review: P4-LONG-WINDOW-PRODUCER-V1

**Status:** $status
**Reviewed:** 2026-06-18T13:35:34.6746268+08:00

## Paths

| Artifact | Path |
|----------|------|
| Task     | docs\pm\outbox\P4-LONG-WINDOW-PRODUCER-V1.md |
| Report   | docs\pm\reports\P4-LONG-WINDOW-PRODUCER-V1.md |
| Log      | P4-LONG-WINDOW-PRODUCER-V1.jsonl (not found) |
| Lock     | P4-LONG-WINDOW-PRODUCER-V1.lock.json (not found) |
