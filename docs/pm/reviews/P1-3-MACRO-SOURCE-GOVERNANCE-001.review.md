# Review: P1-3-MACRO-SOURCE-GOVERNANCE-001

**Status:** $status
**Reviewed:** 2026-06-18T13:35:35.6828412+08:00

## Paths

| Artifact | Path |
|----------|------|
| Task     | docs\pm\outbox\P1-3-MACRO-SOURCE-GOVERNANCE-001.md |
| Report   | docs\pm\reports\P1-3-MACRO-SOURCE-GOVERNANCE-001.md |
| Log      | P1-3-MACRO-SOURCE-GOVERNANCE-001.jsonl (not found) |
| Lock     | P1-3-MACRO-SOURCE-GOVERNANCE-001.lock.json (not found) |
