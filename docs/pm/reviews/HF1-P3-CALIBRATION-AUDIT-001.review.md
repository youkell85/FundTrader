# Review: HF1-P3-CALIBRATION-AUDIT-001

**Status:** $status
**Reviewed:** 2026-06-18T13:35:33.1277171+08:00

## Paths

| Artifact | Path |
|----------|------|
| Task     | docs\pm\outbox\HF1-P3-CALIBRATION-AUDIT-001.md |
| Report   | docs\pm\reports\HF1-P3-CALIBRATION-AUDIT-001.md |
| Log      | HF1-P3-CALIBRATION-AUDIT-001.jsonl (not found) |
| Lock     | HF1-P3-CALIBRATION-AUDIT-001.lock.json (not found) |
