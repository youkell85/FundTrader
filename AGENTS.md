...
This project is indexed by GitNexus as **FundTrader** (14267 symbols, 23776 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
