...
This project is indexed by GitNexus as **FundTrader** (14653 symbols, 24539 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
