...
This project is indexed by GitNexus as **FundTrader** (12155 symbols, 20858 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
