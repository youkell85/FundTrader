...
This project is indexed by GitNexus as **FundTrader** (8347 symbols, 14635 relationships, 290 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
