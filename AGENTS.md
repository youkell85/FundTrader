...
This project is indexed by GitNexus as **FundTrader** (14183 symbols, 23654 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
