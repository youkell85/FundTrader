...
This project is indexed by GitNexus as **FundTrader** (13853 symbols, 23095 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
