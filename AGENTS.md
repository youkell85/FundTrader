...
This project is indexed by GitNexus as **FundTrader** (7992 symbols, 13926 relationships, 277 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
