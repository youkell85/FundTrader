...
This project is indexed by GitNexus as **FundTrader** (14034 symbols, 23391 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
