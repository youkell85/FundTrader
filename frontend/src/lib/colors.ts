...
// === 中性视觉色（用于非涨跌信息）===
export const ACCENT_PRIMARY = "#45B084"; // 品牌主色（按钮/链接/图表线条）
export const ACCENT_INFO = "#8FD9BA"; // 信息绿（夏普、信息比率等中性指标）
export const ACCENT_HIGHLIGHT = "#D69D63"; // 评级铜金（仅星级使用）
...
// === 风险/回撤指标专用色（始终为绿色或暖色）===
export const RISK_COLOR = "#D69D63"; // 警示铜金（用于波动率、回撤标识）
